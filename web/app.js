...
document.querySelector('#exportBtn').addEventListener('click', async () => {
  ...
  const contents = JSON.stringify({ version: 4, exportedAt: new Date().toISOString(), ...state }, null, 2);
...
resetForm();
// Prepiši stariji zapis bez nekadašnjih podataka za plaćanje, uz očuvanje očitanja i cijena.
saveState();
render();
